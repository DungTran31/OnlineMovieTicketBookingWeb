...
using OnlineMovieTicketBookingWeb.Areas.Identity.Models.AccountViewModels;
using OnlineMovieTicketBookingWeb.Areas.Identity.Models.ManageViewModels;
using OnlineMovieTicketBookingWeb.Areas.Identity.Models.RoleViewModels;
using OnlineMovieTicketBookingWeb.Areas.Identity.Models.UserViewModels;
using OnlineMovieTicketBookingWeb.Data;
using OnlineMovieTicketBookingWeb.ExtendMethods;
...
namespace OnlineMovieTicketBookingWeb.Areas.Identity.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, MovieTicketBookingContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
