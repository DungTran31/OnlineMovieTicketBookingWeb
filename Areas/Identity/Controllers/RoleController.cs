...
namespace OnlineMovieTicketBookingWeb.Areas.Identity.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, MovieTicketBookingContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
